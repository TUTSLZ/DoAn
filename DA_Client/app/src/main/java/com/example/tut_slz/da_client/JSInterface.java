...
public class JSInterface extends Activity{
    ...
    public void SendToServer(String sUsername, String sPhoneNumber, String sAddr){
        ...
        activity.runOnUiThread(new Runnable() {
            ...
            public void run() {
                String sbJson="";
                sbJson+="{\"userOrderName\":\""+ClientDA.sUsername+"\",\"phone\":\""+ClientDA.sPhoneNumber+"\",\"address\":\""+ClientDA.sAddr+"\",\"totalPrice\":\""+sTotalPrice+"\",\"listFood\":\"";
                for(int i=0;;){
                    sbJson+=Order.FOrder.get(i).getItem().getId()+"."+Order.FOrder.get(i).getCount();
